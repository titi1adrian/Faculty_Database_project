...
<center> 
	...
	<title>Afisare Completa Materiale</title>
	</head>
...
<table border='4'>
 ...
 <tbody>
	...
	<?php
        ...
        $query = "SELECT * FROM tblMateriale WHERE stocMaterial > 0";
		$result= mysqli_query($db,$query) or die('Error querying for whole tblAngajati');
		while($row=mysqli_fetch_array($result)){
			echo "<tr>";
			echo "<td>" . $row['denumireMaterial'] . "</td>";
			echo"<td>" . $row['pretMaterial'] . "</td>";
			echo"<td>" . $row['furnizorMaterial'] . "</td>";
			echo"<td>" . $row['stocMaterial'] . "</td>";
			echo "</tr>";
		}
		echo "</table>";
		echo "</tr>\n";
